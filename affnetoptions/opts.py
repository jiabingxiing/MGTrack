...
from affnetcommon import SUPPORTED_MODALITIES
from affnet import modeling_arguments
# from affnetdata.collate_fns import arguments_collate_fn
...
from affnetoptions.utils import load_config_file
from affnetutils import logger
...
def get_training_arguments(parse_args: Optional[bool] = True):
    ...
    parser.add_argument('--script', type=str, default='tts_sparse', help='training script name')
    parser.add_argument('--config', type=str, default='conv1k228_fpn_m', help='yaml configure file name')
    parser.add_argument('--save_dir', type=str, default='.', help='the directory to save checkpoints and logs')
    parser.add_argument('--param', type=str, default='conv1k228_fpn_m', help='name of config file')
