...
from ...positional_encoding.untied.relative import generate_2d_relative_positional_encoding_index, RelativePosition2DEncoder


def build_cross_attention_based_encoder(drop_path_allocator,
